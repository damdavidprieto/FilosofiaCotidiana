...
// === CATEGORY FILTERS ===
const categories = {
    ESTOICISMO: ['Dicotomía del Control', 'Amor Fati', 'Meditación sobre la Muerte', 'Apatheia', 'Tranquilidad de Ánimo'],
    EXISTENCIALISMO: ['Existencialismo (Esencia)', 'Mala Fe', 'El Absurdo', 'El Otro', 'Autenticidad Moderna', 'Soledad Existencial'],
    ORIENTAL: ['Impermanencia', 'Wu Wei (No-Acción)', 'Karma (Causalidad)', 'Dharma (Propósito)', 'El Camino Medio', 'Anatman (No-Yo)', 'Ubuntu', 'Sankofa'],
    ETICA: ['El Imperativo Categórico', 'Eudaimonía', 'El Velo de la Ignorancia', 'Ley Natural', 'Ética del Cuidado', 'Ética del Cuidado Feminista'],
    CONTEMPORANEO: ['Capitalismo de Vigilancia', 'Realismo Capitalista', 'Filosofía Cyborg', 'Necropolítica', 'Banalidad del Mal', 'Industria Cultural', 'Aceleracionismo']
};
